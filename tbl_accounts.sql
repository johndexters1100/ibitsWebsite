...
CREATE TABLE IF NOT EXISTS `tbl_accounts` (
  ...
  `account_ContactNumber` int(11) NOT NULL,
...
INSERT INTO `tbl_accounts` (`account_StudentNumber`, `account_LastName`, `account_FirstName`, `account_MiddleName`, `account_Year`, `account_Email`, `account_ContactNumber`, `account_Address`, `account_Birthday`, `account_Age`, `account_Password`) VALUES
('2018-00058-BN-0', 'Satsatin', 'John Dexter', 'Ortiz', 3, 'johndexters1100@gmail.com', 2147483647, '9565 PASEO C.A. Ortiz St.', '2000-10-01', 20, 'pogiako');
COMMIT;
